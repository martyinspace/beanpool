...
export function MapPage() {
    ...
    async function handleCreatePost() {
        ...
        setPosting(true);
        try {
            const identity = JSON.parse(localStorage.getItem('beanpool-identity') || '{}');
        ...
        <div style={{ position: 'relative', width: '100%', height: '100%' }}>
            ...
            {!showNewPost && (
                <button
                    ...
                    style={{
                        position: 'absolute', bottom: '5rem', right: '0.75rem',
                        width: '52px', height: '52px', borderRadius: '50%',
                        background: '#2563eb', border: 'none', color: '#fff',
                        fontSize: '1.6rem', cursor: 'pointer', zIndex: 1000,
            ...
            {showNewPost && (
                <div style={{
                    position: 'absolute', bottom: '4rem', left: '0.75rem', right: '0.75rem',
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '0.5rem' }}>
                        <button onClick={useMyLocation} style={{
                            ...
                            color: '#fff', border: (postLat != null && !pinDropMode) ? '1px solid #22c55e' : '1px solid #444',
                            fontSize: '0.8rem', cursor: 'pointer', fontFamily: 'inherit',
                        }}>
                            📍 My location
                        </button>
                        <button onClick={enterPinDrop} style={{
                            flex: 1, padding: '0.4rem', borderRadius: '8px',
                            background: pinDropMode ? '#1a3a5c' : '#222',
                            color: '#fff', border: pinDropMode ? '1px solid #3b82f6' : '1px solid #444',
                            fontSize: '0.8rem', cursor: 'pointer', fontFamily: 'inherit',
                        }}>
                            📌 Drop a pin
                        </button>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '0.5rem' }}>
                        ...
                        <input
                            ...
                            onChange={e => setNewPostCredits(e.target.value)}
                            style={{
