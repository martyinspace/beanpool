                                                ...
                                                {project.proposerPubkey === identity.publicKey && project.status === 'proposed' && (
                                                    <div className="flex gap-1">
                                                        <button 
                                                            ...
                                                            className="text-nature-400 hover:text-amber-500 p-1 bg-transparent border-none cursor-pointer text-[12px]"
                                                            title="Edit"
                                                        ...
                                                        <button 
                                                            ...
                                                            className="text-nature-400 hover:text-red-500 p-1 bg-transparent border-none cursor-pointer text-[12px]"
                                                            title="Delete"
